...
try
{
    ...
    Console.WriteLine();
    Console.WriteLine($"Check it with: src\\devops\\Rowles.LeanCorpus.Cli\\bin\\Release\\net10.0\\leancorpus-cli.exe check \"{options.IndexPath}\" --deep");
    return 0;
}
...
{
    Console.WriteLine("Usage: dotnet run --project src\\examples\\Rowles.LeanCorpus.Example.NewsgroupsIndexer -- [options]");
    Console.WriteLine();
