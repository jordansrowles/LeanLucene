...
using Rowles.LeanCorpus.Example.JsonApi;
using Rowles.LeanCorpus.Example.JsonApi.Models;
using Rowles.LeanCorpus.Search.Queries;
using Rowles.LeanCorpus.Search.Suggestions;

var builder = WebApplication.CreateBuilder(args);

string dataPath = builder.Configuration["LEANCORPUS_DATA_PATH"]
    ?? Environment.GetEnvironmentVariable("LEANCORPUS_DATA_PATH")
