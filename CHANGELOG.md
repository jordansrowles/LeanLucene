...
- Public `IndexValidator.Check` API and `leanlucene-cli.exe check` command for structured index validation with text and JSON output.
...
- The command-line checker project now builds as `leanlucene-cli.exe`.
