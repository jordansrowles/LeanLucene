...
public class PrefixQueryBenchmarks
{
    ...
    {
        var query = new Rowles.LeanLucene.Search.PrefixQuery("body", QueryPrefix);
    ...
    {
        _leanIndexPath = Path.Combine(Path.GetTempPath(), $"leanlucene-bench-prefix-{Guid.NewGuid():N}");
